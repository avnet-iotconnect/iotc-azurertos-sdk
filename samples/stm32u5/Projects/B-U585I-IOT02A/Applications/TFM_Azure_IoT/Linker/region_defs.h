...
// really NS_DATA_SIZE_2, but hacking it up so less files are affected
//#define NS_DATA_SIZE                        (_SRAM1_SIZE_MAX)
#define NS_DATA_SIZE                        (_SRAM3_SIZE_MAX - SRAM3_S_SIZE)
#define NS_DATA_SIZE_2                      (_SRAM3_SIZE_MAX - SRAM3_S_SIZE)
// really NS_DATA_LIMIT_2, but hacking it up so less files are affected
//#define NS_DATA_LIMIT                       (NS_DATA_START + NS_DATA_SIZE - 1)
#define NS_DATA_LIMIT                       (NS_DATA_START_2 + NS_DATA_SIZE_2 - 1)
