...
const uint8_t dcd_data[] = {
	...
	/* #1.83, command: write_value, address: SEMC_BMCR0, value: 0x30524, size: 4 */
	0x40, 0x0D, 0x40, 0x08, 0x00, 0x03, 0x05, 0x24,
	/* #1.84, command: write_value, address: SEMC_BMCR1, value: 0x6030524, size: 4 */
	...
	/* #1.86, command: write_value, address: SEMC_SDRAMCR0, value: 0xF35, size: 4 */
