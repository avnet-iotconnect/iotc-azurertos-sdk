...
create_threadx_projects() {
  ...
  case "$name" in
	...
	# Explicit use of wget as curl not working with github archive
      wget -q -O azrtos.zip https://saleshosted.z13.web.core.windows.net/sdk/AzureRTOS/Azure_RTOS_6.1_ADU_Renesas_RX65N_Cloud_Kit_e2studio_gnurx_Sample_2022_04_28.zip
